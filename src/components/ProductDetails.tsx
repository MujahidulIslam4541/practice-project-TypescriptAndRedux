...
//                 className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-600 focus:ring-2 focus:ring-amber-400 focus:outline-none text-white font-semibold rounded-lg shadow-md transition-all duration-200"
//               >
